...
class GPUOptimizedMermaidTrainer:
    """GPU优化的Mermaid流程图生成LoRA训练器 - 针对A800 GPU优化"""
...
请生成完整的Mermaid代码："""
    ...
    def tokenize_function(self, examples):
        ...
        # Mermaid代码通常较长，增加最大长度
        tokenized = self.tokenizer(
            texts,
            truncation=True,
            padding=True,
            max_length=3072,  # 进一步增加最大长度以适应Mermaid代码
            return_tensors="pt",
        )
    ...
    def prepare_training_data(self):
        ...
        tokenized_dataset = dataset.map(
            ...
            batched=True,
            batch_size=4,  # 减小批处理大小，因为Mermaid代码较长
    ...
    def train(self, output_dir=None):
        ...
        try:
            ...
            if output_dir is None:
                ...
                output_dir = f"./lora_results_mermaid_{timestamp}"
            ...
            training_args = TrainingArguments(
                ...
                per_device_train_batch_size=1,  # Mermaid代码较长，进一步减小批处理大小
                per_device_eval_batch_size=1,
                gradient_accumulation_steps=8,  # 增加梯度累积步数以补偿较小的批处理大小
                num_train_epochs=8,  # 适当减少训练轮数
...
def main():
    ...
    parser = argparse.ArgumentParser(description="GPU优化的LoRA微调 - Mermaid流程图生成专用")
    ...
    # 创建训练器并开始训练
    trainer = GPUOptimizedMermaidTrainer(args.model_path, args.data_path)
