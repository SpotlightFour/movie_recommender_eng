...
class DetailedExplanationTrainer:
    """详细论证解释的LoRA训练器"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="详细论证解释的LoRA微调")
    ...
    # 创建训练器并开始训练
    trainer = DetailedExplanationTrainer(args.model_path, args.data_path)
